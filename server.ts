...
НЕ используй синтаксис markdown. Верни ТОЛЬКО готовый HTML код.`,
      ...
      const imageGenerationPromise = new Promise<{ imageUrl?: string; warningMsg?: string }>(async (resolve) => {
        ...
        try {
             ...
             let customWarning = "";
             if (lightxKeyFromHeader?.startsWith("AIza")) {
